...
static void subghz_scene_read_raw_update_statusbar(void* context) {
    ...
    FuriString* frequency_str = nullptr;
    FuriString* modulation_str = nullptr;
    ...
    subghz_read_raw_add_data_statusbar(
        subghz->subghz_read_raw, furi_string_get_cstr(frequency_str), furi_string_get_cstr(modulation_str));
...
void subghz_scene_read_raw_on_enter(void* context) {
    ...
    case SubGhzRxKeyStateRAWLoad:
        ...
        subghz_read_raw_set_status(
            subghz->subghz_read_raw, SubGhzReadRAWStatusLoadKeyTX, furi_string_get_cstr(file_name));
        ...
        case SubGhzCustomEventViewReadRAWREC:
            if(subghz->txrx->rx_key_state != SubGhzRxKeyStateIDLE) {
                ...
                if(subghz_protocol_raw_save_to_file_init(
                    ...
                    furi_string_set_str(subghz->error_str, "Function requires\nan SD card.");
